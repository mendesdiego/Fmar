...
if(!is_admin()){
	...
	/* JS */
	wp_enqueue_script( 'jQuery', get_template_directory_uri() . '/js/jquery-3.1.1.js', array(), '3.1.1', false );
	...
	wp_enqueue_script( 'Funções', get_template_directory_uri() . '/js/funcoes.js', array(), time(), true );
}
