...
$mail = new PHPMailer();
    ...
    $mail->AddAddress("suporte03@grupoandrademartins.com.br", "Inscrição -  Bolsas Famart");
    $mail->AddAddress("vendas@grupoandrademartins.com.br", "Inscrição -  Bolsas Famart");
    $mail->AddAddress("mktdigital@grupoandrademartins.com.br", "Inscrição -  Bolsas Famart");
    /*$mail->AddAddress("corporativo@grupoandrademartins.com.br", "Inscrição -  Bolsas Famart");*/
    ...
    // =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
    $mail->Subject = "Inscrição Processo Seletivo FAMART"; // Assunto da mensagem
    $array_nomes = array(
    ...
    $template = file_get_contents("templates/inscricao_selecao_grupo.tpl");
		...
		<div id = "box950" class = "box950 centraliza  ">
			...
			<div class = "infocontato">
				...
				<div id = "topo-descricao">
					<h1 style="text-align:center;">Inscrição Processo de Seleção</h1>
					<hr>
					<p style="font-size: 1.4em; text-align:center;">
						Muito obrigado por se inscrever em nosso <strong>Processo de Seleção</strong>.
					</p>
					<p style="font-size: 1.4em; text-align:center;">Verifique seu e-mail, confirme os dados e caso encontre algo incorreto, favor nos avisar.</p>
					<p style="font-size: 1.4em; text-align: center;"><strong>Estamos torcendo pelo seu sucesso</strong>.</p>
					<p style="font-size: 1.4em; text-align: center;"><strong>Boa sorte!</strong></p>
