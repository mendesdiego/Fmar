    ...
    <div id = "containner" class = "box800 centraliza">
        ...
        <div class="box-100">
            <div class="espacamento_padrao texto-descricao">
                <p>Preencha o <strong>formulário</strong> abaixo com seus dados para realizar sua inscrição.</p>
                <p style="margin-top: 13px;">Após o preenchimento, você receberá em até 48 horas um e-mail de confirmação de inscrição.</p>
                <p style="margin-top: 13px;">Confirme seus dados no e-mail e caso haja algo incorreto pedimos que nos informe.</p>
                <p style="margin-top: 13px;">A <strong>FAMART – Faculdade Martins</strong> deseja lhe deseja <strong>boa sorte</strong> e <strong>boas vindas</strong> por estar certo de seu sucesso!</p>
                <p style="margin-top: 13px;">Dúvidas poderão ser esclarecidas em nossa página do <strong><a href="https://www.facebook.com/faculdadefamart" target="_blank">Facebook</a></strong> ou pelo telefones <strong>0800 037 4212</strong> ou <strong>(37) 3241-4212</strong>.</p>

            </div>
        </div>

        <form name="formulario-inscricao" method="POST" id="formulario-inscricao" action="/obrigado-inscricao-processo-de-selecao">
