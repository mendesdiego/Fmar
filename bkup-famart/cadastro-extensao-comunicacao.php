...
$query = "SELECT * FROM extensao_comunicacao c WHERE c.idCurso =$id";
...
while ($linha = mysql_fetch_array($sql)) {
    ...
    <div id = "containner" class = "box800 centraliza">
        <form name="formulario-inscricao" method="POST" action="pgto-extensao.php" id="formulario-inscricao">
            <fieldset>
                <div class = "legenda">
                    <p></p>
                </div>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td width = "460" class = "field">
                                ...
                                <font color = '#3399CC'><strong><?php echo $linha['valor1']; ?></strong></font>
                                <input type = "hidden" name = "Valor" id = "Valor" size = "20" value="<?php echo $linha['valor1']; ?>" />
                            </td>
                        </tr>
                    </table>
                </fieldset>
