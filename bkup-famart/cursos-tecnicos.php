...
<head>
  ...
  <link rel="stylesheet" href="css/cursos.css" type="text/css" media="all" />
...
<body>
  ...
  <div class = "wrapper">
    ...
    <div class="col-md-12">
      ...
      <?php
      require('conexao.php');
      $query = "SELECT * FROM  cursos_tecnicos ORDER BY nome ASC";
      $sql = mysql_query($query, $con) or die(mysql_error());
      while ($linha = mysql_fetch_array($sql)) {
        ?>
        <div class="col-md-4 box-50-left">
          <div class="cursos-graduacao-interno">
            <div class="hover ehover4">
              <?php echo "<img src=img/cursos/" . ($linha['imagem']) . " alt='' class='img-responsive wp-post-image'>";?>
              <div class="overlay">
                <?php echo("<h2>" . $linha['nome'] . "</h2>");?>
                <a href = "informacoes-cursos-tecnicos.php?IdCurso=<?php echo($linha['IdCurso']); ?>" class="link-grid">
