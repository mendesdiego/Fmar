...
if (array_key_exists('enviar', $_POST)) {
    ...
    $sql = "INSERT INTO cadastro_moodle(nome,cpf,email,profissao,cidade,possui_r2,telefone,rg,celular,formacao,possui_graduacao,curso_interesse_pos,pretende_fazer_pos,pretende_especializacao,curso_escolhido,ip,graduacao,como_conheceu)

VALUES ('$nome','$cpf','$email','$profissao','$cidade','$possui_r2','$telefone','$rg','$celular','$formacao','$possui_graduacao','$curso_interesse_pos','$pretende_fazer_pos','$pretende_especializacao','$curso_escolhido','$ip','$graduacao','$como_conheceu')";
...
mysql_query($sql,$con) or die(mysql_error());
    ...
    $mail->FromName = "Famart Moodle - Cadastro Cursos Livres"; // Seu nome
    ...
    $mail->AddBCC('corporativo@grupoandrademartins.com.br', 'Contato Via Site'); // Copia
    $mail->AddBCC('vendas@grupoandrademartins.com.br', 'Contato Via Site'); // Copia
    ...
    // =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
    $mail->Subject = " Fale Conosco (não responder)"; // Assunto da mensagem
    $array_nomes = array(
        '{Nome}',
        '{CPF}',
        '{Email}',
    ...
    $template = file_get_contents("templates/teste.tpl");
...
location.href='http://www.famart.com.br'
 </script>  ";
