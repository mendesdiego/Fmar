...
$.extend($.validator, {
	...
	messages: {
		...
		Data: "Por favor insira uma data válida.",
		DataISO: "Por favor insira uma data válida (ISO).",
		Numero: "Por favor insira um número válido.",
		Digitos: "Por favor, digite apenas dígitos.",
		...
		maxlength: $.validator.format("Por favor, indique mais de {0} caracteres."),
