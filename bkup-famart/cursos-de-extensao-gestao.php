    ...
    <div class = "wrapper">
        ...
        <section>
            ...
            <section class = "gridView" id = "tbex1">
                <?php
                require('conexao.php');
                $query = "SELECT * FROM  extensao_gestao ";
                ...
                while ($linha = mysql_fetch_array($sql)) {
                    ...
                    <figure class = "grid">
                        ...
                        <figcaption>
                            ...
                            <a href = "informacoes-extensao-gestao.php?IdCurso=<?php echo($linha['IdCurso']); ?>">
                                <input id = "cadastrar" type = "submit" value = "saiba mais">
                            </a>

                            <a href = "cadastro-extensao-gestao.php?IdCurso=<?php echo($linha['IdCurso']); ?>">
