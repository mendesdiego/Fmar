...
<body>
	...
	while ($linha = mysql_fetch_array($sql)) {
		...
		<form action = "envia-curso-livre.php" method = "POST">
				<fieldset>
					<div class = "legenda">
						<p></p>
					</div>
					<table>
						...
						<tr>
							...
							<td width = "460" class = "field"><label
								for = "Curso"></label><?php echo $linha['NomeCurso']; ?>
								<input type = "hidden" name = "Curso" id = "Curso" value = "Artes" />
							</td>
                    ...
                    <tr>
                       ...
                       <td>
                        <span class = "field">
                           <input type = "radio" name = "FormaPagamento" id = "radio2" value = "1 X R$ 69,90" />
                           <strong><font color = '#3399CC'><?php /*echo "R$" . $linha['valor1']; */?></font>
                               <!--  SEGUNDO VALOR OPCIONAL  !!! É SO DESCOMENTAR QUE ELE JA APARECE
                              <label for="FormaPagamento2">
                                <input type="radio" name="FormaPagamento" id="radio4" value="18 Vezes" />
                                <strong><font color='#3399CC'><?php /*echo "R$" . $linha['valor2']; */?></font>
                                </label> -->
            ...
            <fieldset>
            	<table>
            		...
            		<tr>
            			...
            			<td class = "field">
            				<input name = "CPF" class = "cpf" type = "text" id = "CPF" size = "20"
            				required />
            				Somente números
            			</td>
