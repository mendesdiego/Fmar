	...
	<div id = "containner" class = "containner100">
		...
		<div id = "conteudo">
			...
			<div class="pag">
				...
				A <strong>FAMART</strong> também faz parte da Campanha da Responsabilidade Social do Ensino Superior Particular e carrega com o orgulho o selo que isso representa. <br><br>
				...
				Clique nas imagens abaixo para conhecer melhor a campanha.

				<div class="logos-centro">
					<div class="centraliza-logos">
						<div class="img-logo e-10">
							<a href="http://www.sisdia.abmes.org.br/hotsite/index/id/8844/ano/2015/" target="blank">
								<img src="img/campanha-social.png">
							</a>
						</div>
						<div class="img-logo">
							<a href="baixar.php?arquivo=carta.pdf">
								<img src="img/selo-social-p.png">
							</a>
						</div>
					</div>
				</div>
