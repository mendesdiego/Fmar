				...
				<div>
					...
					<div class="p-acord-tabs2 f-left">
						...
						<font class="investimento">
							<?php echo $linha['InvestimentoMensalPOR'] . "/mês" ?>
						</font>
					</div>
					<div class="p-acord-tabs3 f-left">
						<button class="f-left botao-acord-detalhes">
							<a href="<?php echo("/$categoria/$area/{$linha['link']}/detalhes") ?>">
								VEJA DETALHES
							</a>
						</button>
					</div>
					<div class="p-acord-tabs4">
						<button class="f-left botao-inscricao-p">
