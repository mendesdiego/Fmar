...
<head>
    ...
    // exit();
					...
					$sql = "INSERT INTO cadastro_extensao
					(
						Curso,
						Valor,
						cpf,
...
$mail = new PHPMailer();
			...
			//$mail->AddAddress("suporte@grupoandrademartins.com.br", "Contato Online FAMART");
			    ...
			    $mail->AddAddress("vendas@grupoandrademartins.com.br", "Inscrição -  Cursos de Extensão");
			    $mail->AddAddress("diget@grupoandrademartins.com.br", "Inscrição -  Cursos de Extensão");
			    $mail->AddAddress("direcaoacademica@famart.edu.br", "Inscrição -  Cursos de Extensão");
			    ...
			    $template = file_get_contents("templates/inscricao_extensao.tpl");
