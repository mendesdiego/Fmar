    ...
    <div class = "wrapper">
        ...
        <section>
            ...
            <section class = "gridView" id = "tbex1">
                <?php
                require('conexao.php');
                $query = "SELECT * FROM  extensao_comunicacao ";
                ...
                while ($linha = mysql_fetch_array($sql)) {
                    ...
                    <figure class = "grid">
                        ...
                        <figcaption>
                            ...
                            <a href = "informacoes-extensao-comunicacao.php?IdCurso=<?php echo($linha['IdCurso']); ?>">
                                <input id = "cadastrar" type = "submit" value = "saiba mais">
                            </a>
                            <a href = "cadastro-extensao-comunicacao.php?IdCurso=<?php echo($linha['IdCurso']); ?>">
