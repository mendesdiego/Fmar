						...
						<div class="tabs-grids">
							<div id="parentVerticalTab">
								<ul class="resp-tabs-list hor_1">
									...
									<div class="box-info">
										<h3 class = "titulo-info "><i class="fa fa-clock-o fa-2x" aria-hidden="true"></i> DURAÇÃO</h3>
										<div class="sub-info">4 anos</div>
									</div>
									<div class="box-info">
										<h3 class = "titulo-info "><i class="fa fa-usd fa-2x" aria-hidden="true"></i> VALOR DO CURSO</h3>
										<div class="sub-info" style="color: #00a824;">R$ 249,90</div>
									</div>
								</ul>
