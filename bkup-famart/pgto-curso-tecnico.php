	...
	<style>
		...
		<script>
			!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?
				...
				<body>
					...
					if (array_key_exists('inscricaoonline', $_POST)){
						...
						$sql = "INSERT INTO cadastro_tecnico
						(
						Curso,
						Valor,
						cpf,
			...
			//$mail->AddAddress("suporte@grupoandrademartins.com.br", "Contato Online FAMART");
			    ...
			    $mail->AddAddress("web01@grupoandrademartins.com.br", "Inscrição -  Curso Técnico");
			    $mail->AddAddress("vendas@grupoandrademartins.com.br", "Inscrição -  Curso Técnico");
			    $mail->AddAddress("mktdigital@grupoandrademartins.com.br", "Inscrição -  Curso Técnico");
			    $mail->AddAddress("vendas@grupoandrademartins.com.br", "Inscrição -  Curso Técnico");
			    $mail->AddAddress("diget@grupoandrademartins.com.br", "Inscrição -  Curso Técnico");
			    $mail->AddAddress("direcaoacademica@famart.edu.br", "Inscrição -  Curso Técnico");
			    ...
			    // =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
			    $mail->Subject = "Confirmação dos dados de inscrição - Curso Técnico"; // Assunto da mensagem
			    $array_nomes = array(
			    ...
			    $template = file_get_contents("templates/inscricao_tecnico.tpl");
					...
					<div id = "box950" class = "box950 centraliza  ">
						...
						<div class = "infocontato">
							...
							<div class="infocontato centraliza-div-interna">
								...
								<input name="itemDescription1" type="hidden" value="<?php echo isset($_POST['Curso'])?$_POST['Curso']."Técnico - Famart":NULL ?>">  
