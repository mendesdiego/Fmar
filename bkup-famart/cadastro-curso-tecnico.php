...
<body>
	...
	$query = "SELECT * FROM cursos_tecnicos c WHERE c.idCurso =$id";
	...
	while ($linha = mysql_fetch_array($sql)) {
		...
		<div id = "containner" class = "box800 centraliza">
			<form name="formulario-inscricao" method="POST" action="pgto-curso-tecnico.php" id="formulario-inscricao">
				<fieldset>
					<div class = "legenda">
						<p></p>
					</div>
					<table>
						<tr>
							<td width = "177" class = "label">
								<label id = "ListaCurso" for = "ListaCurso">Curso Técnico:</label>
							</td>
							<td width = "460" class = "field">
								<labelfor = "Curso"></label>
									<?php echo $linha['nome']; ?>
									<input type = "hidden" name = "Curso" id = "Curso" value = "<?php echo $linha['nome']; ?>" />
								</td>
							...
							<tr>
								<td width = "177" class = "label"><label id = "ListaCurso" for = "ListaCurso">Valor da Matrícula:</label>
								</td>
								<td width = "460" class = "field">
									<label for = "Curso"></label>
									<font color = '#3399CC'><strong><?php echo 'R$ 50,00'; ?></strong></font>
