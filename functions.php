...
/* ----------------------------------------------------- */
/* Carregando o arquivo de FORMULARIO DE PROMOÇÃO */
/* ----------------------------------------------------- */

/*require_once('functions/form_promocao.php');*/

/*************************************************************/
/* CUSTOMIZA A PAGINA DE LOGIN */
require_once('functions/custom-wp-login.php');
/**********************************************************/
/*------------------------------------------------------*/
require_once('functions/bootstrap-menu.php');
register_nav_menu('top-bar', __('principal'));

/*require_once('functions/yamm-nav-walker.php');*/
...
function get_current_slug($echo=false){
